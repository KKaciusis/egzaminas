...
app.put('/api/planes/newTime:id', (request, response) => {
    const QUERY_UPDATE = "UPDATE planes SET arrival_time=? WHERE id=" + request.params.id;
    const VALUES = [request.body.newTime];
...
app.put('/api/planes/newStatus:id', (request, response) => {
    const QUERY_UPDATE = "UPDATE planes SET is_late=? WHERE id=" + request.params.id;
    const VALUES = [request.body.newStatus];
